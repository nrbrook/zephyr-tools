...
from map_file_utils import (
    parse_map_file, filter_sections, group_by_directory,
    get_section_total, get_object_total,
    ROM_SECTIONS, RAM_SECTIONS
)
...
Examples:
  ...
  Generate HTML report:
    ...
    parser.add_argument('--min-size', type=int, default=0,
                      help='Only show symbols larger than this size in bytes')
    parser.add_argument('--by-symbol', action='store_true',
                      help='Group identical symbols across all objects')
